...
% ── Metadados da versão ─────────────────────────────────────────────────────
\newcommand{\hayversiontag}{v1.0.0}
...
\begin{center}
  ...
  \begin{tabularx}{\textwidth}{@{}lXl@{}}
    ...
    v1.0.0 & Saída PNG (via feature \code{png\_backend})                        & Planejado \\
    v1.0.0 & \code{geom\_ribbon} --- bandas de intervalo de confiança           & Futuro \\
    v1.0.0 & \code{geom\_smooth} --- regressão LOESS/linear                    & Futuro \\
    v1.0.0 & \code{theme\_*} --- temas de estilo (dark, minimal, classic)       & Futuro \\
    \bottomrule
  \end{tabularx}
\end{center}
