...
\begin{center}
  ...
  \begin{tabularx}{\textwidth}{@{}lXl@{}}
    ...
    v0.2.0 & \code{geom\_line} --- séries temporais e tendência                 & Planejado \\
...
\begin{center}
  ...
  \begin{tabularx}{\textwidth}{@{}L{4.8cm}L{4.0cm}X@{}}
    ...
    \code{geom\_point(plot, color, size)}          & \code{Dict, String, Float}          & Adiciona camada de dispersão \\[3pt]
...
\noindent\textbf{Cores disponíveis em \code{geom\_point()}:}
