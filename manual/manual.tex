...
% ── Metadados da versão ─────────────────────────────────────────────────────
\newcommand{\hayversiontag}{v0.7.1}
...
\begin{center}
  ...
  \begin{tabularx}{\textwidth}{@{}lXl@{}}
    ...
    v0.7.1 & \code{facet\_wrap}, \code{render\_facets} --- painéis por grupo  & $\times$ Desabilitado (arquitetura) \\
...
\begin{alertbox}[title={\textbf{Nota:} Faceting desabilitado}]
  As funções \code{facet\_wrap} e \code{render\_facets} foram desabilitadas na v0.7.1 devido a limitações arquiteturais.
  Elas serão reimplementadas em uma versão futura com uma abordagem diferente.
\end{alertbox}
