...
% ── Metadados da versão ─────────────────────────────────────────────────────
\newcommand{\hayversiontag}{v0.9.0}
...
\begin{center}
  ...
  \begin{tabularx}{\textwidth}{@{}lXl@{}}
    ...
    v0.9.0 & Saída PNG (via feature \code{png\_backend})                        & Planejado \\
    v0.9.0 & \code{geom\_ribbon} --- bandas de intervalo de confiança           & Futuro \\
    v0.9.0 & \code{geom\_smooth} --- regressão LOESS/linear                    & Futuro \\
