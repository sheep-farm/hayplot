...
% ── Metadados da versão ─────────────────────────────────────────────────────
\newcommand{\hayversiontag}{v0.5.0}
...
\begin{center}
  ...
  \begin{tabularx}{\textwidth}{@{}lXl@{}}
    ...
    v0.6.0 & Suporte a cores hexadecimais (\code{\#RRGGBB})                     & Planejado \\
    v0.6.0 & \code{scale\_x\_log10}, \code{scale\_y\_log10} --- eixos em log    & Planejado \\
    v0.6.0 & \code{facet\_wrap} --- painéis por grupo                           & Planejado \\
    v0.7.0 & Saída PNG (via feature \code{png\_backend})                        & Futuro \\
    v0.7.0 & \code{geom\_ribbon} --- bandas de intervalo de confiança           & Futuro \\
    v0.7.0 & \code{geom\_smooth} --- regressão LOESS/linear                    & Futuro \\
    v0.8.0 & \code{theme\_*} --- temas de estilo (dark, minimal, classic)       & Futuro \\
    \bottomrule
  \end{tabularx}
\end{center}
